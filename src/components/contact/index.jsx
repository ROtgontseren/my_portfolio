    ...
    <div className="w-full py-6" id="contact">
        <div className='w-3/5 mx-auto relative bg-transparent'>
            <div className="w-3/5 p-8 pr-24 rounded-2xl bg-white mx-auto">
               <div className="flex">
                 <h2 className="text-2xl text-[#00efff] font-bold ">Contact Me</h2>
               </div>
               ...
               <button className="py-3 px-2 text-[12px] font-bold text-gray-100 bg-[#00efff] rounded-xl hover:bg-blue-700">Send Message</button>
            </div>
            <div className="bg-[#00efff] rounded-2xl absolute bottom-6 right-2 w-1/4 p-6">
               <div className="flex flex-col text-white">
                 <div className="flex flex-col">
                         <div className='flex items-center gap-2'>
                            <PiCityLight color='black'/>
                           <h2 className="text-xl text-black font-bold">Hometown</h2>
                         </div>
                         <p className="text-black white-space: nowrap">Ulaanbaatar, Mongolia</p>
                 </div>
                 <div className="flex flex-col">
                         <div className='flex items-center gap-2'>
                            <FaPhoneAlt color='black'/>
                           <h2 className="text-xl text-black font-bold">Call</h2>
                         </div>
                         <p className="text-black white-space: nowrap">Tel:+976 95669607</p>
                 </div>
                 <div className="flex flex-col">
                         <div className='flex items-center gap-2'>
                           <MdOutlineMail color='black'/>
                           <h2 className="text-xl text-black font-bold">Email</h2>
                         </div>
                         <p className="text-black white-space: nowrap">Email:otgoohghg.com</p>
                 </div>
               </div>
            </div>
        </div>
